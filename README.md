Introduction and Game Flow of Boids

What is Boids?:
  - Boids is an artificial life program developed by Craig Reynolds in 1986 that simulates the flocking behaviour of birds, fish and other smaller animals that travel is packs or "flocks".
  - The Boids follow three basic rules to imitate these mannerism's which will be discussed later within the document:
      - Seperation, the distance between the Boids
      - Alignment, the angular direction the Boid is facing
      - Cohesion, the centerial mass of nearby Boids
  - It should be noted that the Boids only use these three rules when within a certain range of other Boids.
  - From the general logic of Boids themselves, multiple variations can be made such as:
      - obstacle avoidance
      - predators/prey
      - goal-seeking behavior
  
Overall Boids are a unique way to immitate and simulate the enviroment of "Artifical Life" that surrounds in day to day animals.
Now lets talk about the three main Rules that these Boids follow, and the steps we'll take to implement them:
...
Below I have added my hopefully thoughts that I am aiming the user is able to modify to customize their experience when using my application:
